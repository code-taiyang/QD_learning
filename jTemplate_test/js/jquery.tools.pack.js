...
(function (a, b) {
    ...
    function bk(a, b) {
        var c;
        b.nodeType === 1 && (b.clearAttributes && b.clearAttributes(), b.mergeAttributes && b.mergeAttributes(a), c = b.nodeName.toLowerCase(), c === "object" ? b.outerHTML = a.outerHTML : c !== "input" || a.type !== "checkbox" && a.type !== "radio" ? c === "option" ? b.selected = a.defaultSelected : c === "input" || c === "textarea" ? b.defaultValue = a.defaultValue : c === "script" && b.text !== a.text && (b.text = a.text) : (a.checked && (b.defaultChecked = b.checked = a.checked), b.value !== a.value && (b.value = a.value)), b.removeAttribute(f.expando), b.removeAttribute("_submit_uploads"), b.removeAttribute("_change_uploads"))
    }
    ...
    f.event = {
            ...
            setup: function () {
                ...
                f.event.add(this, "click._submit keypress._submit", function (a) {
                    ...
                    d && !d._submit_uploads && (f.event.add(d, "submit._submit", function (a) {
                        a._submit_bubble = !0
                    }), d._submit_uploads = !0)
                })
            },
            ...
            setup: function () {
                ...
                f.event.add(this, "beforeactivate._change", function (a) {
                    var b = a.target;
                    z.test(b.nodeName) && !b._change_uploads && (f.event.add(b, "change._change", function (a) {
...
(function () {
    ...
    jQuery.fn.provincecity = function (opts) {
        opts = jQuery.extend({
        ...
        var _sel1 = jQuery('#' + opts.selProvince);
        var _sel2 = jQuery('#' + opts.selCity);
        _sel1.append("<option value='" + opts.defProvinceVal + "'>" + opts.defProvinceVal + "</option>");
        jQuery.each(Object$Province, function (index, data) {
            _sel1.append("<option value='" + data + "'>" + data + "</option>")
        });
        _sel2.append("<option value='" + opts.defCityVal + "'>" + opts.defCityVal + "</option>");
        var index1 = "";
        _sel1.change(function () {
            _sel2.empty();
            index1 = this.selectedIndex;
            jQuery.each(Object$City[index1 - 1], function (index, data) {
                _sel2.append("<option value='" + data + "'>" + data + "</option>")
            })
        });
        return this
    }
    ...
    $.extend($.fn, {
        colorPicker: function (opt) {
            $(this).each(function () {
                var o = opt;
                if (!o) var o = {};
                if (o.colorValues == undefined) o.colorValues = Array("", "#953503", "#35381D", "#003906", "#03316D", "#020274", "#282AA1", "#373737", "#7C0200", "#F76905", "#848000", "#037B0D", "#008589", "#0001FE", "#63649D", "#7E7E7E", "#FE0000", "#F7981A", "#93CD00", "#2D9C69", "#21D4CE", "#3860FF", "#700788", "#909090", "#F60EE0", "#FFC500", "#FFFC01", "#00FF00", "#0CFFFD", "#03CBFF", "#AB245F", "#B9B9B9", "#FF8CCE", "#FFCB90", "#FFFF94", "#BFFFC5", "#C4FFFF", "#92CDFF", "#D996FF", "#FFFFFF");
                if (o.buttonBackClassName == undefined) o.buttonBackClassName = "colorPicker_button_back";
                if (o.buttonBackColorClassName == undefined) o.buttonBackColorClassName = "colorPicker_button_color";
                if (o.buttonOnPopupClassName == undefined) o.buttonOnPopupClassName = "colorPicker_button_back_popup";
                ...
                if (o.defaultColor == undefined) o.defaultColor = "";
                ...
                $(this).val(cval);
                if (o.obj != undefined) o.obj.css("color", cval);
                ...
                $("#picker_panel_" + $(this).attr('id') + " a").each(function () {
                    ...
                    $(this).click(function () {
                        ...
                        if (o.obj != undefined) o.obj.css("color", $(this).data('color_value'));
                        hidePanel();
                        return false;
                    });
                });
...
(function () {
    ...
    jQuery.fn.contextMenu = function (id, options) {
        if (!menu) {
            menu = jQuery('<div id="jqContextMenu"></div>').hide().css({
                position: 'absolute',
                zIndex: '500'
        ...
        fileTree: function (o, h) {
            ...
            jQuery(this).each(function () {
                ...
                function bindTree(t) {
                    ...
                    if (o.folderEvent.toLowerCase != 'click') jQuery(t).find('LI A').bind('click', function () {
                        return false
                    })
                }
...
(function () {
    jQuery.fn.ajaxSubmit = function (options) {
        ...
        if (options.iframe || found) {
            if (jQuery.browser.safari && options.closeKeepAlive) jQuery.get(options.closeKeepAlive, fileUpload);
            else fileUpload()
        ...
        function fileUpload() {
            ...
            var io = $io[0];
            if (jQuery.browser.msie || jQuery.browser.opera) io.src = 'javascript:false;document.write("");';
            $io.css({
                position: 'absolute',
                top: '-1000px',
                left: '-1000px'
            ...
            setTimeout(function () {
                ...
                try {
                    if (options.extraData)
                        for (var n in options.extraData) extraInputs.push(jQuery('<input type="hidden" name="' + n + '" value="' + options.extraData[n] + '" />').appendTo(form)[0]);
                    $io.appendTo('body');
    ...
    function log() {
        if (jQuery.fn.ajaxSubmit.debug && window.console && window.console.log) window.console.log('[jquery.form] ' + Array.prototype.join.call(arguments, ''))
    }
})(jQuery);
...
(function () {
    jQuery.fn.jtip = function (opts) {
        ...
        var tip = null,
            cancelHide = false;
        this.hover(function () {
            if (jQuery("#jtip").is("div")) {
                return
            }
            if (jQuery(this).attr('tip') && jQuery(this).attr('tip') != "") {
                jQuery.data(this, 'cancel.jtip', true);
                var tip = jQuery.data(this, 'active.jtip');
                if (!tip) {
                    tip = jQuery('<div id="jtip" class="jtip"><div id="jtip-inner" class="jtip-inner">' + jQuery(this).attr('tip') + '</div></div>');
                    tip.css({
                        position: 'absolute',
                        zIndex: 1000
                    });
                    jQuery(this).attr('title', '');
                    jQuery.data(this, 'active.jtip', tip)
                };
                var pos = jQuery.extend({}, jQuery(this).offset(), {
                ...
                bgiframe = jQuery('<iframe class="bgiframe" frameborder="0" scrolling="no" src="" style="display:block;position:absolute;z-index:999;' + 'top:' + (jQuery('#jtip').offset().top) + 'px;' + 'left:' + (jQuery('#jtip').offset().left) + 'px;' + 'width:' + (tip[0].offsetWidth - 2) + 'px;' + 'height:' + (tip[0].offsetHeight - 2) + 'px;' + '"></iframe>');
                bgiframe.appendTo(document.body)
            }
        }, function () {
            if (jQuery(this).attr('tip') && jQuery(this).attr('tip') != "") {
                jQuery.data(this, 'cancel.jtip', false);
                var self = this;
                setTimeout(function () {
                    if (jQuery.data(this, 'cancel.jtip')) return;
                    var tip = jQuery.data(self, 'active.jtip');
                    if (opts.fade) {
...
(function (jQuery) {
    ...
    this.lays = function (width, height, top) {
        if ($("#PopTips").is("div")) {
            return
        };
        if (width != 0 && width) this.layer.width = width;
        if (height != 0 && height) this.layer.height = height;
        if (top != 0 && top) this.layer.top = top
    };
            ...
            if (!this._literalMode) {
                ...
                t = t.replace(/\{(.*?)\}/g, function (__a0, __a1) {
                    try {
                        ...
                        if (Template.DEBUG_MODE) throw e;
                        return ""
                    }
                })
            }
    ...
    jQuery.formValidator = {
            ...
            switch (setting.validateType) {
                ...
                case "InputValidator":
                    ...
                    case "CompareValidator":
                        ...
                        return false;
                    case "AjaxValidator":
                        if (stype == "text" || stype == "password" || stype == "textarea" || stype == "file" || stype == "select-one") {
                            return true
                        } else {
                            return false
                        }
        ...
        AjaxValid: function (returnObj) {
            ...
            if (setting.addidvalue) {
                var parm = id + "=" + encodeURIComponent(srcjo.val());
